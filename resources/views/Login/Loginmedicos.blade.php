		...
		<div class="container-login100" style="background-image: url({{url('Login/images/fondo1.jpg')}}">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt><br><br><br><br>
					<img src="{{ asset ('Login/images/perfil.jpg') }}" alt="IMG">
				</div>

				<form action="{{ route ('validamedico') }}" method="POST">
          {{ csrf_field() }}
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="{{route('restaurarconmed')}}">
							/ Recuperar
						</a>
					</div>
					<br>
					...
					<div class="text-center">
						...
						<br>
						<a class="txt2" href="{{ route('altamedico') }}">
							Crear cuenta nueva
